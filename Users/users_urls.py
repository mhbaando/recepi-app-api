...
urlpatterns = [
    ...
    path("manage_users/<str:action>", ManageUsers, name="ManageUsers"),
    ...
    path("manage_permission/<str:id>", ManagePermission, name="ManageRoles"),
    path("manage_permission_report", PermissonReport, name="PermissonReport"),
    path(
        "manage_group_permission/<str:id>/<str:_id>",
        ManageGroupPermission,
        name="ManageGroups",
    ),
    path("manage_group/<str:id>", ManageGroup),
    path("rename_group", RenameGroup),
